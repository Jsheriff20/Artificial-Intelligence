...
//
//    var averageWeatherTemp = AverageWeatherTemp.FromJson(jsonString);

namespace average_weather_temp_namespace
{
    using System;
    using System.Collections.Generic;
    ...
    public partial class AverageWeatherTemp
    {
    ...
    public partial class AverageWeatherTemp
    {
        public static AverageWeatherTemp FromJson(string json) => JsonConvert.DeserializeObject<AverageWeatherTemp>(json, average_weather_temp_namespace.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this AverageWeatherTemp self) => JsonConvert.SerializeObject(self, average_weather_temp_namespace.Converter.Settings);
    }
